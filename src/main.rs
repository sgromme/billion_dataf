...
fn main() {
    // put in the path
    let path = "/home/sgromme/source/1brc/data/measurements.txt";
    let _path = "/home/sgromme/source/billion_dataf/measurements.txt";
    ...
    let df = rt.block_on(ctx.read_csv(_path, opts)).unwrap();
